describe("Scheduler", function () {
    ...
    describe("Speed", function () {
        ...
        var A50 = Object.create(A);
        A50.speed = 50;
        var A100a = Object.create(A);
        A100a.speed = 100;
        var A100b = Object.create(A);
        A100b.speed = 100;
        var A200 = Object.create(A);
        A200.speed = 200;
        beforeEach(function () { S.clear(); });
    ...
    describe("Zero-ID actor", function () {
        var schedulers = [ROT.Scheduler.Simple, ROT.Scheduler.Action];
        schedulers.forEach(function (schedulerCtor, i) { return describe("scheduler ".concat(i), function () {
            var s = new schedulerCtor();
            var A1 = 0;
